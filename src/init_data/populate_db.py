            ...
            sample_boxes = [
                {
                    ...
                    "geometry": json.dumps({
                        "type": "Polygon",
                        "coordinates": [
                            [[-95.0, 40.0], [-95.0, 41.0], [-94.0, 41.0], [-94.0, 40.0], [-95.0, 40.0]]
                        ]
                    })
                },
                {
                    ...
                    "geometry": json.dumps({
                        "type": "Polygon",
                        "coordinates": [
                            [[-93.0, 42.0], [-93.0, 43.0], [-92.0, 43.0], [-92.0, 42.0], [-93.0, 42.0]]
                        ]
                    })
                }
            ]
            ...
            sample_fields = [
                {
                    ...
                    "geometry": json.dumps({
                        "type": "Polygon",
                        "coordinates": [
                            [[-94.8, 40.2], [-94.8, 40.8], [-94.2, 40.8], [-94.2, 40.2], [-94.8, 40.2]]
                        ]
                    }),
                ...
                },
                {
                    ...
                    "geometry": json.dumps({
                        "type": "Polygon",
                        "coordinates": [
                            [[-92.8, 42.2], [-92.8, 42.8], [-92.2, 42.8], [-92.2, 42.2], [-92.8, 42.2]]
                        ]
                    }),
                ...
                },
                {
                    ...
                    "geometry": json.dumps({
                        "type": "Polygon",
                        "coordinates": [
                            [[-94.6, 40.5], [-94.6, 40.9], [-94.3, 40.9], [-94.3, 40.5], [-94.6, 40.5]]
                        ]
                    }),
