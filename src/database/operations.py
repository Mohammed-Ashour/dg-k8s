...
class DatabaseOperations:
    ...
    def register_field(self, name:str, geometry:Mapping[str,Any], planting_date:str) -> int:
    ...
    def record_processing_attempt(self, field_id:int, bbox_id:int, processing_type:str,
                                 processing_time=None, error_code=None):
    ...
    def record_missed_field(self, field_id:int, bbox_id:Mapping[str,Any], processing_time:str):
